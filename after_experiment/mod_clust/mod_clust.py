...
from after_experiment.run_models import run_i4vk, run_W2SAT, run_GWAE2SAT
...
def main():
    ...
    small_gvae_total = os.path.join(args.GWAE2SAT, "small_total_generations")
    ...
    # run_W2SAT(args.src)
    # try:
    #     assert len(os.listdir(small_gwae2sat_allo)) > 0
    # except:
    #     run_GWAE2SAT(args.src, args.gwae2sat_train, "allo")
    # print("Small Allo-GWAE2SAT ready.")

    # try:
    #     assert len(os.listdir(big_gwae2sat_allo)) > 0
    # except:
    #     run_GWAE2SAT(args.src, args.gwae2sat_train, "allo", False)
    # print("Big Allo-GWAE2SAT ready.")

    # try:
    #     assert len(os.listdir(small_gwae2sat_auto)) > 0
    # except:
    #     run_GWAE2SAT(args.src, args.src, "auto")
    # print("Small Auto-GWAE2SAT ready.")

    # try:
    #     assert len(os.listdir(big_gwae2sat_auto)) > 0
    # except:
    #     run_GWAE2SAT(args.src, args.src, "auto", False)
    # print("Big Auto-GWAE2SAT ready.")
    ...
    for sat_file in os.listdir(args.src):
        ...
        # lookup[sat_file]["small_allo_gwae2sat"] = scores_for_sat_file(sat_file,
        #                                                               small_gwae2sat_allo,
        #                                                               '-')
        # lookup[sat_file]["big_allo_gwae2sat"] = scores_for_sat_file(sat_file,
        #                                                             big_gwae2sat_allo,
        #                                                             '-')
        # lookup[sat_file]["small_auto_gwae2sat"] = scores_for_sat_file(sat_file,
        #                                                               small_gwae2sat_auto,
        #                                                               '-')
        # lookup[sat_file]["big_auto_gwae2sat"] = scores_for_sat_file(sat_file,
        #                                                             big_gwae2sat_auto,
        #                                                             '-')
        lookup[sat_file]["small_total_gvae"] = scores_for_sat_file(sat_file,
                                                                   small_gvae_total,
                                                                   '-')
    ...
    comparisons = [
        # "Original", "EGNN2S", "G2SAT",
                   # "W2SAT",
        "Small-Total-GVAE"
                   # "Small-Allo-GWAE2SAT", "Big-Allo-GWAE2SAT",
                   # "Small-Auto-GWAE2SAT", "Big-Auto-GWAE2SAT"
    ]
    ...
    for sat_instance in lookup.keys():
        try:
            flat = lookup[sat_instance]["small_total_gvae"]
            # flat = lookup[sat_instance]["original"]
            # flat += lookup[sat_instance]["egnn2s"]+lookup[sat_instance]["g2sat"]
            # flat = lookup[sat_instance]["w2sat"]
            # flat += lookup[sat_instance]["small_allo_gwae2sat"]
            # flat += lookup[sat_instance]["big_allo_gwae2sat"]+lookup[sat_instance]["small_auto_gwae2sat"]
            # flat += lookup[sat_instance]["big_auto_gwae2sat"]
            df.loc[sat_instance] = flat
        except:
            continue

    print(df)
    df.to_csv("whole_gvae_results.csv", index_label="Instance")
